    ...
    public partial class Form1 : Form
    {
        ...
        void inerkenYaz()       //saniye artarken tetris bloklarını yazıyor.
        {
            if (sekil == 0)     // sekil 0 I şekli.
            {
                    if (sayac < 4)
                    {
                        TablePanel.GetControlFromPosition(sutun, satir).BackgroundImage = Properties.Resources.ui;
                        sayac++;
                    }
                    else
                    {
            ...
            if (sekil == 1)     //şekil 1 kare şekli.
            {
                ...
                {
                    TablePanel.GetControlFromPosition(sutun, satir).BackgroundImage = Properties.Resources.ui;
                    TablePanel.GetControlFromPosition(sutun + 1, satir).BackgroundImage = Properties.Resources.ui;
                    sayac++;
                }
                else
                {
            ...
            if (sekil == 3)     // şekil 3 Z şeklini temsil ediyor.
            {
                ...
                if (sayac == 1)
                {
                    TablePanel.GetControlFromPosition(sutun, satir+1).BackgroundImage = Properties.Resources.ui;
                ...
                else
                {
                    if (satir <17)
                    {
                        ...
                        TablePanel.GetControlFromPosition(sutun, satir).BackgroundImage = Properties.Resources.ui;
                        TablePanel.GetControlFromPosition(sutun, satir + 1).BackgroundImage = Properties.Resources.ui;
                        TablePanel.GetControlFromPosition(sutun + 1, satir + 1).BackgroundImage = Properties.Resources.ui;
                        TablePanel.GetControlFromPosition(sutun - 1, satir - 1).BackgroundImage = null;
                    ...
                    for (int j = 16; j > 0; j--)
                    {
                        for (int k = 0; k < 10; k++)
                        {
                            ...
                            if (TablePanel.GetControlFromPosition(k, j).BackgroundImage != null)
                            {
                                ...
                                TablePanel.GetControlFromPosition(k, j + 1).BackgroundImage = Properties.Resources.ui;
                            }
                        }
                    }
                }
                ...
                if (e.KeyCode == Keys.Right)        //sağ ok tuşuna basıldığı zaman blokları 1 sağa taşıyoruz
                {
                    if (satir > 3)
                    {
                        ...
                        if (sekil == 0)
                        {
                            sutun++;
                            TablePanel.GetControlFromPosition(sutun, satir - 1).BackgroundImage = Properties.Resources.ui;
                            TablePanel.GetControlFromPosition(sutun, satir - 2).BackgroundImage = Properties.Resources.ui;
                            TablePanel.GetControlFromPosition(sutun, satir - 3).BackgroundImage = Properties.Resources.ui;
                            TablePanel.GetControlFromPosition(sutun, satir - 4).BackgroundImage = Properties.Resources.ui;
                        }
                        ...
                        if (sekil == 1)
                        {
                            if (sutun < 8)
                            {
                                ...
                                TablePanel.GetControlFromPosition(sutun, satir - 2).BackgroundImage = Properties.Resources.ui;
                                TablePanel.GetControlFromPosition(sutun + 1, satir - 1).BackgroundImage = Properties.Resources.ui;
                                TablePanel.GetControlFromPosition(sutun + 1, satir - 2).BackgroundImage = Properties.Resources.ui;
